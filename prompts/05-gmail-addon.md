...
# Gmail Add‑on: Cozy Density, Truncation, Optimistic Actions
...
## Deliverables
1) /addon/addon.ts
2) /addon/components.ts
3) /tests/unit/addon.cards.spec.ts

## Acceptance Criteria
- [ ] KeyValue truncated 1–2 lines
- [ ] Optimistic Undo actions
