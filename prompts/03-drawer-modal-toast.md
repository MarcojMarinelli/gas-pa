...
## Deliverables
1) /src/ui/components/Drawer.ts
2) /src/ui/components/Modal.ts
3) /src/ui/components/Toast.ts
4) /tests/unit/overlays.keyboard.spec.ts

## Acceptance Criteria
- [ ] Focus trapped; Esc closes; return focus
- [ ] Background inert; scroll locked
- [ ] Toast 4s default; aria-live polite
